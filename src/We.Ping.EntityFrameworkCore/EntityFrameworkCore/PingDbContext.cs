    ...
    ITenantManagementDbContext
{
    ...
    #region Smart Ping Entities
    public DbSet<ClubPourDepartement> ClubPourDepartement { get; set; }
    #endregion
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(PingConsts.DbTablePrefix + "YourEntities", PingConsts.DbSchema);
